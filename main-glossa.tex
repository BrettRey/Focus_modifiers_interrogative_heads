...
\begingroup
\centering
\textit{Word count: 1249 (including footnotes and references)}\par
\endgroup
...
\ea\label{ex:paradigm}
  ...
  \ex[]{\mention{I saw} [\mention{exactly what you did}]\mention{.} \hfill (fused relative)} \label{ex:fused}
...
In \mention{the person who called}, the relative clause is backgrounded. Adding \mention{exactly} attempts to foreground \mention{who}~-- but \mention{who} is embedded in backgrounded content. The result is a clash.

Fused relatives escape this problem because the relative word is at-issue~-- it's the locus of identification, not background information. \mention{Exactly what you said} identifies the referent; the relative word bears the focus of the identification. No clash arises.
